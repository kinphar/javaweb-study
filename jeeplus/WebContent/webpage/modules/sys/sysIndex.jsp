...
<head>
    ...
    <meta name="keywords" content="Lively快速开发平台">
    <meta name="description" content="Lively，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="https://shop129230100.taobao.com/shop/view_shop.htm?spm=a230r.1.14.17.JILITf&user_number_id=53169053">http://www.taobao.com</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->

    ...
    <div class="ibox-content">
       <form class="form-horizontal">
    	<div class="form-group">
             ...
             <div class="col-sm-8">
             		<input type="text" id="encoderContent" title="输入内容" value="https://shop129230100.taobao.com/shop/view_shop.htm?spm=a230r.1.14.17.JILITf&user_number_id=53169053" class="form-control">
